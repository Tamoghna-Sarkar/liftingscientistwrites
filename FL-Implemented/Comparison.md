...
|--------|-----------------------|------------------------|-------------------------------------|----------------------------|---------------------|--------------------------|
| **Real Device Use** | Yes (Android phones) | Yes (Alibaba devices, ~100) | Yes (Android phones, varied demographics) | Yes (phones in FL testbed) | Yes (AWS Device Farm) | Yes (Raspberry Pi + Android) |
...
| **Experiment Scale** | ~20 devices per round (logical) | ~100 real + synthetic clients | ~50 real smartphones | 50–100 real Android phones | ~30 devices via AWS | 5–50 nodes (virtual + physical) |
